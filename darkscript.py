...
colorama.init()
print(Fore.GREEN + Style.BRIGHT + ">>> Руководство по авторизации в скрипте @darkscript1")
print("")
...
@app.on_message(filters.command("obrezanie", prefixes=".") & filters.me)
async def valentine(app, msg):
	zaika = 0
	zaika2 = 0
	while zaika < 100:
		await msg.edit(f'''
			🧰 Готовим инструменты... {zaika}%''')
		zaika += 1
	if zaika >= 100:
		await msg.edit(f'''
			💉Делаем анестезию.. .''')
...
@app.on_message(filters.command("narkota", prefixes=".") & filters.me)
...
📙<b> Команды:</b> \n<b> - https://telegra.ph/Komandy-04-27</b> \n

💎 <b>Приобрести PREMIUM Script: </b>\n <b>- https://t.me/darkscript1/22</b> \n
